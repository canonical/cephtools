...
# one-time: list VM hosts and note the name for your LXD host (e.g. local-lxd)
maas <profile> vm-hosts read | jq -r '.[]|.name'

export TF_VAR_lxd_vm_host="local-lxd"
